...
namespace chess{
    ...
    public:
        ...
        void updateAllLegalMoves(const BoardView& boardView, const GameState& gameState) { m_AllLegalMoves = m_MovmentLogic->getAllLegalMoves(m_Position, m_Threats, m_Color, boardView, gameState); };
