...
namespace chess{
    ...
    public:
        ...
        virtual std::vector<Move> getAllLegalMoves(Position figurePosition, const std::vector<Position>& figureThreats, Color color, const BoardView& boardView, const GameState& gameState) const = 0;
    ...
    public:
        ...
        std::vector<Move> getAllLegalMoves(Position figurePosition, const std::vector<Position>& figureThreats, Color color, const BoardView& boardView, const GameState& gameState) const override;
