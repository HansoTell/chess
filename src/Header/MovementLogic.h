...
namespace chess{
    ...
    public:
        ...
        virtual std::vector<Position> getThreatendSquares(const Position figPos, const BoardView& BoardView) const = 0;
    ...
    public:
        ...
        std::vector<Position> getThreatendSquares(const Position figPos, const BoardView& BoardView) const;
